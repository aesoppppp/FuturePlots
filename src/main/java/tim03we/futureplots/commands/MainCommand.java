...
public class MainCommand extends Command {
    ...
    public MainCommand() {
    	super("땅", "땅 관련 명령어", "§7§l[§b땅 도우미§7] §7/땅 <서브명령어>");
        setAliases(new String[]{"plot", "plots"});
        commandParameters.clear();
        this.commandParameters.put("default", new CommandParameter[]{
                new CommandParameter("서브명령어", false, convertToStringArray(CommandHandler.commmands, CommandHandler.aliases)),
                new CommandParameter("플레이어", CommandParamType.TARGET, true)
        });
    }
